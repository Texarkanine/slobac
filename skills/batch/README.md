...
- `../audit/references/docs/taxonomy/<slug>.md` — canonical smell definitions for each in-scope smell
- `../audit/references/behavior-summary-format.md` — the output format spec for behavior summaries
