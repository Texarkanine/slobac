...
- **Manifesto is canonical.** The audit cites the manifesto; it does not fork it. If a detection feels right but the manifesto's Signals don't cover it, that is a signal the manifesto needs extending — stop and surface it as a manifesto gap, do not carry detection content outside the canonical entry.
