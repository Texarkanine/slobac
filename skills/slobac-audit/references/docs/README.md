...
1. Read the manifesto:
    ...
    - **[Taxonomy](taxonomy/README.md)** — the catalog of named failure modes, one entry per smell. Start with `taxonomy/README.md` for the curated reading order across the taxonomy entries; each entry is a standalone page you can jump to directly.
